...
// Auth Check
if (!isset($_SESSION['role']) || !in_array($_SESSION['role'], ['admin', 'superadmin', 'manager', 'accountant'])) {
...
if ($support_id < 1) { header("Location: admin_support.php"); exit; }
...
if (!$ticket) { header("Location: admin_support.php?msg=NotFound"); exit; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($reply_msg === "") {
        ...
        try {
            ...
            $db->commit();
            header("Location: admin_support_view.php?id=$support_id&msg=success");
            exit;
        } catch (Exception $e) {
            $db->rollback();
...
<div class="d-flex">
        ...
        <div class="flex-fill main-content-wrapper" style="margin-left: 280px; transition: margin-left 0.3s ease;">
            ...
            <div class="d-flex justify-content-between align-items-end mb-4">
                <div>
                    <a href="admin_support.php" class="text-decoration-none text-muted small fw-bold"><i class="bi bi-chevron-left"></i> BACK TO QUEUE</a>
