        ...
        <div class="flex-fill main-content-wrapper" style="margin-left: 280px; transition: margin-left 0.3s ease;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-5">
                ...
                <div class="d-flex gap-2">
                    <a href="<?= BASE_URL ?>/public/admin_dashboard.php" class="btn btn-outline-dark rounded-pill px-4 btn-sm fw-bold">
            ...
            <div class="hope-card shadow-sm mb-5">
                <div class="p-4 border-bottom bg-white">
                    <form method="get" class="row g-3 align-items-center">
                        ...
                        <div class="col-md-1">
                            <a href="admin_support.php" class="btn btn-light rounded-pill w-100 fw-bold" title="Clear Filters"><i class="bi bi-x-lg"></i></a>
                        </div>
                        <?php endif; ?>
                    </form>
                </div>
                    ...
                    <table class="table table-hope mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="admin_support_view.php?id=<?= $t['support_id'] ?>" class="btn btn-light btn-sm rounded-circle p-2 shadow-sm" title="Manage Ticket">
