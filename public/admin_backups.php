                ...
                <div class="col-xl-8">
                    <div class="card-custom overflow-hidden">
                        ...
                        <div class="p-3 bg-light text-center">
                            <a href="admin_audit_logs.php" class="text-decoration-none small fw-bold text-dark">View Full Audit Trail <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
