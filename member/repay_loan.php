            ...
            <div class="row w-100 justify-content-center g-4">
                    ...
                    <div class="hd-glass p-4 h-100 d-flex flex-column justify-content-center">
                        ...
                        <div class="list-group list-group-flush bg-transparent">
                            ...
                            <div class="list-group-item bg-transparent d-flex justify-content-between px-0 border-secondary border-opacity-10">
                                ...
                                <span class="fw-bold" style="color: var(--text-main);">KES <?= number_format($loan['amount']) ?></span>
                            </div>
                            <div class="list-group-item bg-transparent d-flex justify-content-between px-0 border-0 pt-3">
                                ...
                                <span class="h4 fw-bold text-danger mb-0">KES <?= number_format($balance, 2) ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="hd-glass p-4 p-md-5">
                        ...
                        <form method="POST" action="<?= BASE_URL ?>/member/mpesa_request.php" id="repayForm">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-text text-muted small">Max payable: KES <?= number_format($balance, 2) ?></div>
                            </div>
