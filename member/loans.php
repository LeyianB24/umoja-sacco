...
$stmt->bind_param("i", $member_id);
$stmt->execute();
$account_balance = $stmt->get_result()->fetch_assoc()['account_balance'] ?? 0;
$stmt->close();
                        ...
                        <div class="card-clean p-4 border-lime" style="border: 2px solid var(--lime-accent);">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <h5 class="fw-bold mb-0">KES <?= number_format($account_balance) ?></h5>
                                </div>
                            </div>
                            <div class="d-grid mt-3">
                                <a href="<?= BASE_URL ?>/member/withdraw.php?type=loans&source=loans" class="btn btn-lime py-2">
