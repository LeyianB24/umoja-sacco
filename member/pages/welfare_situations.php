                            ...
                            <div class="card-body-custom">
                                ...
                                <div class="progress-container">
                                    <div class="d-flex justify-content-between align-items-end mb-2">
                                        <span class="fw-bold text-dark fs-5">KES <?= number_format((float)$raised) ?></span>
                                        <span class="small text-muted">of <?= number_format((float)$target) ?> goal</span>
                                    </div>
                                    <div class="progress">
                                    ...
                                    <div class="mt-2 d-flex justify-content-between">
                                        <small class="text-success fw-bold"><?= number_format((float)$percent, 0) ?>% Funded</small>
                                    </div>
                                </div>
