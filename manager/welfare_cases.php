<?php
// usms/manager/welfare_cases.php
session_start();
...
$allowed_roles = ['superadmin', 'manager', 'accountant'];
...
$can_edit = in_array($my_role, ['superadmin', 'manager']);
$success = $error = '';
...
function ksh($val) { return number_format($val, 2); }
?>
<!DOCTYPE html>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="glass-card p-4 d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="fw-bold mb-0" style="color: var(--dark-green);">KES <?= number_format($total_raised/1000, 1) ?>K</h2>
                        </div>
                        <div class="rounded-circle d-flex align-items-center justify-content-center" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-between small mb-1">
                                        <span class="fw-bold text-success"><?= number_format($percent, 0) ?>%</span>
                                    </div>
