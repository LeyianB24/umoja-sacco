...
require_permission('investment_mgmt');
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6 border-end">
                                            ...
                                            <div class="fw-bold <?= $bal_class ?>">
                                                KES <?= number_format($net_bal) ?>
                                            </div>
                                        </div>
                                        <div class="col-6 ps-2">
                                            <div class="small text-muted mb-1" style="font-size:0.65rem">Total Yield</div>
                                            <div class="fw-bold text-dark">KES <?= number_format($a['realized_income']) ?></div>
                                        </div>
                                    </div>
                                </div>

                                <div class="d-flex justify-content-between align-items-center small mb-2">
                                    <span class="text-muted">Target Progress (<?= number_format($a['target_amount']) ?>)</span>
                                    <span class="fw-bold <?= $progress >= 100 ? 'text-success' : 'text-primary' ?>"><?= number_format($progress, 1) ?>%</span>
                                </div>
