...
/**
 * inc/SystemPDF.php
 * REUSABLE CENTRALIZED PDF TEMPLATE SYSTEM
 * All system PDF exports must extend this class to ensure visual consistency and audit compliance.
 */

if (!file_exists(__DIR__ . '/../fpdf/fpdf.php')) {
    die("FPDF library not found in /fpdf/ directory.");
}
