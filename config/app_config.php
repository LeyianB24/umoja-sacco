...
define('COMPANY_ADDRESS', 'Thika Road, Nairobi, Kenya');
...
define('SITE_FAVICON', ASSET_BASE . '/images/favicon.ico');
...
define('SMS_API_KEY', ''); // Set your SMS API key here (e.g., Africa's Talking)
