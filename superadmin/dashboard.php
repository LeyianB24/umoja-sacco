        ...
        <div class="flex-fill main-content-wrapper" style="margin-left: 280px; transition: margin-left 0.3s ease;">
            ...
            <div class="d-flex justify-content-between align-items-end mb-5">
                ...
                <div class="d-flex gap-3">
                    <a href="role_matrix.php" class="btn btn-lime px-4 py-2 rounded-4 shadow-sm">
                        <i class="bi bi-grid-3x3-gap me-2"></i> Role Matrix
                    </a>
                    <a href="../public/admin_backups.php" class="btn btn-white border px-4 py-2 rounded-4 fw-semibold shadow-sm">
