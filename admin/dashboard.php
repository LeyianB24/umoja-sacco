...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="../public/admin_backups.php" class="btn btn-light border rounded-pill px-3 fw-semibold">
            <i class="bi bi-database-down me-1"></i> Backup
        </a>
        <a href="../public/admin_settings.php" class="btn btn-dark rounded-pill px-3 fw-semibold">
    ...
    <div class="col-lg-8">
        <div class="hd-glass">
            <div class="d-flex justify-content-between align-items-center px-4 py-4 border-bottom">
                ...
                <a href="../public/admin_support.php" class="fw-bold small text-decoration-none" style="color: var(--primary-dark)">View All</a>
            </div>
                            ...
                            <?php foreach ($tickets as $t): ?>
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        <a href="../public/admin_support_view.php?id=<?= $t['support_id'] ?>" class="btn btn-sm btn-outline-dark rounded-pill px-3">Open</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
    ...
    <div class="col-lg-4">
        <div class="hd-glass p-4 h-100">
            ...
            <div class="d-grid gap-2 mt-4">
                <a href="../public/admin_members.php" class="btn btn-light border rounded-3 py-2 text-start fw-semibold">
                    <i class="bi bi-person-badge me-2 text-muted"></i> Member Management
                </a>
                <a href="../public/admin_audit_logs.php" class="btn btn-light border rounded-3 py-2 text-start fw-semibold">
