...
$sql = "
    SELECT 
        ...
        s.status, s.created_at, s.attachment,
        CASE 
    ...
    $where_sql
    ORDER BY FIELD(s.status, 'Pending', 'Open', 'Closed'), s.created_at DESC
";
        ...
        <div class="flex-fill main-content-wrapper" style="margin-left: 280px; transition: margin-left 0.3s ease;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-5">
                ...
                <div class="d-flex gap-2">
                    <a href="dashboard.php" class="btn btn-outline-dark rounded-pill px-4 btn-sm fw-bold">
                    ...
                    <form method="get" class="row g-3 align-items-center">
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" name="q" class="form-control bg-light border-0 shadow-none" placeholder="Search ticket ID or subject..." value="<?= htmlspecialchars($search_query) ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <select name="status" class="form-select bg-light border-0 shadow-none" onchange="this.form.submit()">
                                ...
                                <option value="Open" <?= $status_filter=='Open'?'selected':'' ?>>Open Tickets</option>
                                <option value="Closed" <?= $status_filter=='Closed'?'selected':'' ?>>Resolved</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <button class="btn btn-hope-lime w-100">Filter Queue</button>
                        </div>
                        <?php if($status_filter !== 'all' || $search_query): ?>
                        <div class="col-md-2">
                            <a href="support.php" class="btn btn-light rounded-pill w-100 fw-bold">Clear</a>
                        </div>
                        <?php endif; ?>
                    </form>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <div class="small fw-bold text-dark mb-0"><?= htmlspecialchars($t['sender_name']) ?></div>
                                            <div class="x-small text-muted"><?= $t['sender_role'] ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    <a href="support_view.php?id=<?= $t['support_id'] ?>" class="btn btn-light btn-sm rounded-circle p-2 shadow-sm">
