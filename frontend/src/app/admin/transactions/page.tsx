...
import { FileSpreadsheet, ArrowDownRight, ArrowUpRight, Search } from 'lucide-react';
...
export default function AdminTransactionsLedgerPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
      <div>
        <h1 style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--text-main)' }}>Live General Ledger</h1>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem' }}>Master double-entry transaction record across all member and institutional accounts</p>
      </div>
